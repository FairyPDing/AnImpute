...
#Set a tag
parser.add_argument('--tag_matrix_data', type=str, default='adtag52529_2.csv', help="set the tag matrix.In the paper we choose from : ['adtag52529.csv', 'adtag75748.csv', 'adtag74672.csv', 'adtag9.csv', 'adtag10.csv']")
...
if __name__ == '__main__':
	...
	try:
		...
		print("[!data read] Please make sure that your processed dataset is in data/ in .mat or .csv format and you have entered the filename as data parameter. e.g. 52529.csv")
		exit()
	...
	with tf.Session() as sess:
		...
		with open('52529_ad.csv', mode='w', newline='') as file:
